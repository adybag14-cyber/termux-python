...
cf-wrangler build
test -f "$smoke/.cloudflare/output/v0/workers/default/config.json"
test -f "$smoke/.cloudflare/output/v0/workers/default/bundle/index.js"
